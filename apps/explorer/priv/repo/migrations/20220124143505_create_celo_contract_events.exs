  ...
  def change do
    create table("celo_contract_events", primary_key: false) do
      ...
      add(:transaction_hash,
        references("transactions", column: :hash, type: :bytea, name: :transaction_hash), null: true)
      add(:contract_address_hash,
        references("addresses", column: :hash, type: :bytea, name: :contract_address_hash), null: true)
    ...
    execute("CREATE INDEX celo_contract_events_params_index ON celo_contract_events USING GIN(params)",
