defmodule Explorer.Chain do
  ...
  *NOTE*
  ...
  def voter_rewards_for_group(voter_address_hash, group_address_hash) do
    ...
    voter_activated_or_revoked =
      ...
      |> Repo.all()
      |> Enum.map(fn x ->
        %Explorer.Chain.Data{bytes: amount_activated_or_revoked_bytes} =
          x.amount_activated_or_revoked
        [amount_activated_or_revoked_int | _] = TypeDecoder.decode_raw(amount_activated_or_revoked_bytes, [{:uint, 256}, {:uint, 256}])
    ...
    {epochs, total} =
      ...
      |> Enum.map_reduce(voter_activated_earliest_block.amount_activated_or_revoked, fn curr, amount ->
        ...
        amount =
          if voter_activated_earliest_block.amount_activated_or_revoked != amount && amount_activated_or_revoked != 0 do
