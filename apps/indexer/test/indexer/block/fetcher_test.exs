defmodule Indexer.Block.FetcherTest do
  ...
  describe "import_range/2" do
    ...
    test "imports blocks with dynamic fee (type 0x02) transactions", %{
      ...
      to_address_hash = "0x8bf38d4764929064f2d4d3a56520a76ab3df415b"
      transaction_hash = "0x53bd884872de3e488692881baeec262e7b95234d3965248c39fe992fffd433e5"
      max_fee_per_gas = 78787878
      max_priority_fee_per_gas = 67676767
  ...
  test "imports blocks with custom celo type (type 0x7c) transactions", %{
    ...
    to_address_hash = "0x8bf38d4764929064f2d4d3a56520a76ab3df415b"
    transaction_hash = "0x53bd884872de3e488692881baeec262e7b95234d3965248c39fe992fffd433e5"
    max_fee_per_gas = 343434
    max_priority_fee_per_gas = 565656
    ...
    assert %{transactions: [inserted_transaction]} = inserted
    assert inserted_transaction.type == 124 #0x7c
